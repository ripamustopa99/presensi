...
//   // Gunakan di map
//   const teacherOptions = (teachers as ClassItem[]).map((item) => ({
//     label: item.name,
//     value: item._id,
//   }));
...
//         });
//       } else {
//         reset({ class_name: "", wali: "", _id: undefined });
//       }
//     }
...
//       if (result.success) {
//         onSaveSuccess(); // Panggil agar parent tahu data berubah
//         onClose(); // Tutup modal
...
//         <Input
//           label="Nama Kelas"
//           placeholder="Misal: 7A atau 10-IPA"
...
//         <SelectInput
//           label="Wali Kelas"
//           register={register("wali")} // Pastikan class_name field sesuai schema
//           error={errors.wali?.message}
...
//             type="button"
//             onClick={onClose}
//             className="flex-1 py-4 text-slate-500 font-black uppercase text-[10px] tracking-widest hover:text-white transition-colors"
//           >
//             Batal
//           </button>
